...
#proxychains apt-get dist-upgrade -y
apt-get update
apt-get dist-upgrade -y

# make sure the live build is installed
...
cat $CURDIR/Fddrescue/rsync_exclude.conf > kali-config/common/includes.chroot/etc/rsync_exclude.conf
